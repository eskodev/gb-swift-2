...
class AvailableGroupsTableViewController: UITableViewController {
    var availableGroups = [
        Group(name: "Business Group", image: UIImage(named: "Business")),
        Group(name: "Calculator Group", image: UIImage(named: "Calculator")),
        Group(name: "Card File Group", image: UIImage(named: "Card_file")),
        Group(name: "Company Group", image: UIImage(named: "Company")),
        Group(name: "Delivery Group", image: UIImage(named: "Delivery")),
    ]
